 ...
 */
case class OpenTagProxy(arity: Int, wsCtlBefore: Boolean, wsCtlAfter: Boolean, wsAfter: String) extends Tag {
...
case class CloseTagProxy(arity: Int, wsCtlBefore: Boolean, wsCtlAfter: Boolean, wsAfter: String) extends Tag {
  override def render(rc: RenderControl): RenderControl = rc
